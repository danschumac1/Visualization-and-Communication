...
setwd("C:/Users/dansc/Documents/Gradschool/Visualization and Communication/data/tech_stocks_csv.zip")
...
# Summarize to get the mean of the stock returns stk_ret_mean and stk_ret2_mean.
  ...
  summarize(
    stk_ret_mean = mean(stk_ret, na.rm = T),
    stk_ret_mean2 = mean(stk_ret2, na.rm = T)
  ) 
  
  
HOW TO GET IT INTO PERCENTS!!!!!!
